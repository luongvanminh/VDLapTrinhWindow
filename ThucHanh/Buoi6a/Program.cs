            ...
            while (code != 0)
            {
                ...
                switch (code)
                {
                    ...
                    case 1:
                        ...
                        ThucUong[] arrThuocUong = dataProvider.LietKeThucUong();
                        for (int i = 0; i < arrThuocUong.Length; i++) {
                            // Console.WriteLine(arrThuocUong[i]);
                            Console.WriteLine(arrThuocUong[i].MSHH);
                            Console.WriteLine(arrThuocUong[i].TenHang);
                            Console.WriteLine(arrThuocUong[i].Gia);
                            Console.WriteLine(arrThuocUong[i].TinhTrang);
                        }
                    ...
                    case 2:
                        ...
                        HoaDon[] arrHoaDon = dataProvider.LietKeHoaDon();
                        for (int i = 0; i < arrHoaDon.Length; i++) {
                            Console.WriteLine(arrHoaDon[i].MSDH);
                            Console.WriteLine(arrHoaDon[i].NgayDat.ToString());
                        }
                        ...
                        HoaDonChiTietDatHang[] arrHoaDonChiTietDatHang = dataProvider.LietKeHoaDonChiTietVoiMSDH(msdh);
                        for (int i = 0; i < arrHoaDonChiTietDatHang.Length; i++) {
                            Console.WriteLine(arrHoaDonChiTietDatHang[i].MSDH);
                            Console.WriteLine(arrHoaDonChiTietDatHang[i].MSHH);
                            Console.WriteLine(arrHoaDonChiTietDatHang[i].SoLuong);
                            Console.WriteLine(arrHoaDonChiTietDatHang[i].TiLeGiam);
                        }
                    break;
                    case 3:
                        DatMon(dataProvider);
